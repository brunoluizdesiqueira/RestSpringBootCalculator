package br.com.blsdev.converter;
...
public class DozerConverterTest {
    ...
    @Test
    public void parserEntityToVOTest() {
        PersonVO output = DozerConverter.parserObject(inputObject.mockEntity(), PersonVO.class);
        Assert.assertEquals(Long.valueOf(0L), Long.valueOf(output.getKey()));
    ...
    public void parserEntityListToVOListTest() {
        ...
        Assert.assertEquals(Long.valueOf(0L), Long.valueOf(outputZero.getKey()));
        ...
        Assert.assertEquals(Long.valueOf(7L), Long.valueOf(outputSeven.getKey()));
        ...
        Assert.assertEquals(Long.valueOf(12L), Long.valueOf(outputTwelve.getKey()));
    ...
    public void parserVOToEntityTest() {
        var entity = DozerConverter.parserObject(inputObject.mockVO(), Person.class);
        Assert.assertEquals(Long.valueOf(0L), Long.valueOf(entity.getId()));
        Assert.assertEquals("First Name Test0", entity.getFirstName());
        Assert.assertEquals("Last Name Test0", entity.getLastName());
        Assert.assertEquals("Addres Test0", entity.getAddress());
        Assert.assertEquals("Male", entity.getGender());
    }
    ...
    public void parserVOListToEntityListTest() {
        ...
        Assert.assertEquals(Long.valueOf(0L), Long.valueOf(outputZero.getId()));
        Assert.assertEquals("First Name Test0", outputZero.getFirstName());
        Assert.assertEquals("Last Name Test0", outputZero.getLastName());
        Assert.assertEquals("Addres Test0", outputZero.getAddress());
        Assert.assertEquals("Male", outputZero.getGender());
        ...
        Assert.assertEquals(Long.valueOf(7L), Long.valueOf(outputSeven.getId()));
        Assert.assertEquals("First Name Test7", outputSeven.getFirstName());
        Assert.assertEquals("Last Name Test7", outputSeven.getLastName());
        Assert.assertEquals("Addres Test7", outputSeven.getAddress());
        Assert.assertEquals("Female", outputSeven.getGender());
        ...
        Assert.assertEquals(Long.valueOf(12L), Long.valueOf(outputTwelve.getId()));
        Assert.assertEquals("First Name Test12", outputTwelve.getFirstName());
        Assert.assertEquals("Last Name Test12", outputTwelve.getLastName());
        Assert.assertEquals("Addres Test12", outputTwelve.getAddress());
        Assert.assertEquals("Male", outputTwelve.getGender());
